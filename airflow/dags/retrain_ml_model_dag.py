...
with DAG(
    dag_id="Retrain_ML_Model",
    description="[ML] Retrain model (overwrite in MinIO)",
    default_args=default_args,
    schedule_interval="0 4 * * 0",
    catchup=False,
    tags=["ml", "retrain", "spark"],
) as dag:
    ...
    retrain_model = SparkSubmitOperator(
        ...
        application="/opt/airflow/etl/ml_features/train_mllib.py",
        name="spark_retrain_model",
        executor_cores=2,
        num_executors=2,
        executor_memory="2g",
        driver_memory="512m",
    ...
    start_task >> retrain_model >> end_task
